 ...
 * @author ang3lfco
 */
public class frmReportePruebas extends javax.swing.JFrame {

    /**
     * Creates new form frmRegistrarCliente
     */
    public frmReportePruebas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReportePruebas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReportePruebas().setVisible(true);
            }
        });
    }
